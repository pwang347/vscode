...
export const SessionSupportsComputerUseVideoContext = new RawContextKey<boolean>('sessionSupportsComputerUseVideo', false, localize('sessionSupportsComputerUseVideo', "Whether this session supports viewing its agent-controlled application"));
